...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
			...
			//GameObject Apple = GetComponent<MovementSettings> ().Apple;
			//GameObject Kiwi = GetComponent<MovementSettings> ().Kiwi;
			//GameObject Strawberry = GetComponent<MovementSettings> ().Strawberry;
			//GameObject Banana = GetComponent<MovementSettings> ().Banana;
			//GameObject Pear = GetComponent<MovementSettings> ().Pear;
			//if (Vector3.Distance (transform.position, Apple.transform.position) < 2f) {
				//GetComponent<MovementSettings>().RunMultiplier++;
